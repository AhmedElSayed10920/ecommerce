...
class SuccesResetPass extends StatelessWidget {
  const SuccesResetPass({super.key});
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            const Icon(Icons.verified_user_outlined,size: 200,color: AppColor.primaryColor,),
            const SizedBox(height: 30),
            CustomBodyText(bodyText: "44".tr),
            const SizedBox(height: 30),
            CustomBtnAuth(
              btnText: "13".tr,
              onPressed: () {
